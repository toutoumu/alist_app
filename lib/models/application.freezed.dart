...
class _$ApplicationContextImpl extends _ApplicationContext {
  const _$ApplicationContextImpl({required this.context, required this.ref})
      : super._();
  ...
  @override
  String toString() {
    return 'ApplicationContext(context: $context, ref: $ref)';
  }
...
abstract class _ApplicationContext extends ApplicationContext {
  const factory _ApplicationContext(
      {required final BuildContext context,
      required final WidgetRef ref}) = _$ApplicationContextImpl;
  const _ApplicationContext._() : super._();
